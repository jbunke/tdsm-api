...
public final class GetChoiceNode extends LayerExprNode {
    public static final String NAME = "get_choice";

    public GetChoiceNode(
            final TextPosition pos, final ExpressionNode scope,
            final ExpressionNode[] args
    ) {
        super(pos, scope, TypeNode.getString(), args);
    }
